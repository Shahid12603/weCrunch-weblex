...
const nonVegWrapCombo = "../images/non veg wrap combo.jpg";
const doublePackCombo = "../images/double pack combo.jpg";
const redVelvet = "../images/red velvet.jpg";
const brownie = "../images/brownie3.jpg";
const blackForest = "../images/black forest ice jar.jpg";
const blueBerryMojito = "../images/blue berry mojito.jpeg";
const blueMojito = "../images/blue mojito.jpeg";
const sizzlingBrownie = "../images/brownie1.jpeg";
const caramelBrownie = "../images/brownie2.jpg";
const chickenBBQ = "../images/chicken bbq wrap.jpeg";
const chickenBurger = "../images/chicken burger.jpeg";
const chickenLollipop = "../images/chicken lollipops.jpg";
const chickenNuggets = "../images/chicken nuggets.jpg";
const chickenStrips = "../images/chicken strips.jpg";
const chickenWings = "../images/chicken wings.jpg";
const chickenWrap = "../images/chicken wrap.png";
const chocoBrownSundae = "../images/choco brown sundae.jpeg";
const chocoLava = "../images/choco lava.png";
const chocolateMilkshake = "../images/chocolate milkshake.jpg";
const doubleChickenBurger = "images/double chicken burger.jpeg";
const nonVegComboSmall = "../images/combo s.jpg";
const familyBurgerCombo = "../images/family burger combo.jpg";
const nonVegCombo = "../images/just for 2 combo.jpg";
const mangoMojito = "../images/mango mojito.jpeg";
const milkshakeMealCombo = "../images/milkshake meal combo.jpg";
const mintMojito = "../images/mint mojito.jpg";
...
const pistaMilkshake = "../images/pista milkshake.jpg";
...
const strawBerryMojito = "../images/strawberry mojito.jpeg";
const vanillaIcecream = "../images/vanilla ice cream.jpeg";
const vanillaMilkshake = "../images/vanilla milkshake.jpg";
const vegBurger = "../images/veg burger.jpeg";
